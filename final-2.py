...
arr = (young_demo.head(5)),(mid_demo.head(5)),(old_mid_demo.head(5)),(older_demo.head(5)), (seniors_demo.head(5))
print(arr)
...
arr2 = ['The average charges for someone between eighteen to twenty five is ' +str(eighteen_to_twenty_five), 
        'The average charges for someone between twenty-six and thirty-four is ' +str(twenty_six_to_thirty_four),
        'The average charges for someone between thirty-five and forty-four is ' +str(thirty_five_to_forty_four),
        'The average charges for someone between forty-five and fifty-four is ' +str(forty_five_to_fifty_four),
        'The average charges for someone between fifty-five and older is ' +str(fifty_five_and_older)]
print(' '.join(arr2))
